...
class _AdCreateStep4Form extends State<AdCreateStep4Form> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isAllAgeSelected =
        _ageValues.every((age) => currentSelectedAges.contains(age));
    bool isAllGenderSelected =
        _isCheckedGender.every((element) => element == true);
                      ...
                      child: Column(
                        ...
                        children: [
                          _buildSectionHeader(
                            ...
                            onTap: () {
                              final readProvider =
                                  context.read<AdCreationProvider>();
                              if (isAllAgeSelected) {
                                for (var age in _ageValues) {
                                  if (readProvider.formData.target_ages
                                      .contains(age)) {
                          ...
                          ListView.builder(
                            ...
                            itemCount: _ageValues.length,
                            itemBuilder: (context, index) {
                              final String curValue = _ageValues[index];
                              final bool isSelected = provider
                                  .formData.target_ages
                                  .contains(curValue);
                              return CheckboxListTile(
                                title: Text(
                                  _ageDisplayLabel(curValue),
                                ...
                                onChanged: (bool? value) {
                                  context
                                      .read<AdCreationProvider>()
                                      .setTargetAges(curValue);
                                },
                              );
                            },
                          ),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    context
                        .read<AdCreationProvider>()
                        .setTargetGender(selectedGenders);

                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const AdCreateStep3Form(),
                      ),
                    );
                  },
            ...
            child: Row(
              children: [
                Icon(
                  ...
                  size: 18,
                  color:
                      isSelected ? const Color(0xFF2972C7) : Colors.grey,
                ),
